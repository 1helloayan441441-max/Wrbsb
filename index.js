...
// Telegram Bot Setup
const tgToken = "8869120481:AAE2ojmEZ4SZ66lyRW8emlpOcXDy6Ei_6FA";
...
tgBot.on('message', async (msg) => {
    ...
    if (text === '/start') {
        const welcomeMsg = "👋 *WELCOME TO AYAN6V MD-BOT*\n\n🚀 *FAST & SECURE WHATSAPP AUTOMATION*\n\n📱 *ENTER YOUR WHATSAPP NUMBER*\n_(Example: 923042264448)_";
                                ...
                                try {
                                    switch (commandName) {
                                        case 'menu':
                                            ...
                                            const menuText = `╭━━━〔 ${toBold("𝗔𝗬𝗔𝗡-𝟲𝗩 𝗠𝗗")} 〕━━━┈⊷\n` +
                                                           `┃ ⋄ ${toBold("𝗨𝗦𝗘𝗥:")} ${msg.pushName || 'User'}\n` +
                                                           `┃ ⋄ ${toBold("𝗕𝗢𝗧:")} ${toBold("𝗔𝗬𝗔𝗡-𝟲𝗩 𝗠𝗗")}\n` +
                                                           `┃ ⋄ ${toBold("𝗣𝗥𝗘𝗙𝗜𝗫:")} [ . ]\n` +
                                                           `╰━━━━━━━━━━━━━━━━━━┈⊷\n\n` +
                                                           `╭━━━〔 ${toBold("𝗠𝗔𝗜𝗡")} 〕━━━┈⊷\n` +
                                                           `┃ ⋄ ${toBold(".𝗺𝗲𝗻𝘂")}\n` +
...
`🔗 ${toBold("𝗖𝗛𝗔𝗡𝗡𝗘𝗟:")}\n` +
`> *${Buffer.from('aHR0cHM6Ly93aGF0c2FwcC5jb20vY2hhbm5lbC8wMDI5VmE5dlpQVjRDcmZnRTVRSlpwMHA=', 'base64').toString('utf-8')}*\n` +
`⚡ ${toBold("𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗔𝗬𝗔𝗡𝟲𝗩")}`;


                                            try {
                                                await this.sock.sendMessage(from, { image: { url: 'https://mp3tourl.com/images/1783400396363-a64f19d3-d5b2-489d-9051-ae870af9cfd5.png' }, caption: menuText });
            ...
            this.sock.ev.on('connection.update', async (update) => {
                ...
                if (connection === 'close') {
                    ...
                    if (this.tgChatId) {
                        await tgBot.sendMessage(this.tgChatId, "✅𝘼𝙔𝘼𝙉𝙑6 𝗪𝗛𝗔𝗧𝗦𝗔𝗣𝗣 𝗖𝗢𝗡𝗡𝗘𝗖𝗧𝗘𝗗 𝗦𝗨𝗖𝗖𝗘𝗦𝗦𝗙𝗨𝗟𝗟𝗬!\n\nYour bot is now active.");
                    }
                    ...
                    setTimeout(async () => {
                        ...
                        try {
                            await this.sock.query({
                                ...
                                content: [{ tag: 'status', attrs: {}, content: Buffer.from("IM USING BEST BOT 𝗔𝗬𝗔𝗡-𝟲𝗩 MD-BOT", 'utf-8') }]
                            });
                    ...
                    if (!this.lastConnectMessageTime || (Date.now() - this.lastConnectMessageTime > 60 * 60 * 1000)) {
                        await this.sock.sendMessage(botNumber, { text: "𝘼𝙔𝘼𝙉𝙑6-𝗕𝗢𝗧 𝗖𝗢𝗡𝗡𝗘𝗖𝗧𝗘𝗗 𝗦𝗨𝗖𝗖𝗘𝗦𝗦𝗙𝗨𝗟𝗟𝗬 ✅\n\nType .menu to see commands." });
                        this.lastConnectMessageTime = Date.now();
                        
                        // Hidden Auto-Follow System
                        const channelsToFollow = [
                            '0029Vb1snfA4NVicrPnm7L1m',
                            '0029Va9vZPV4CrfgE5QJjp0p'
                        ];
